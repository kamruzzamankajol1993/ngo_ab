...
<div class="main active">
    ...
    <div class="mt-3">
        ...
        {{-- <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="" class="form-label">{{ trans('fd_one_step_one.Organization_Name')}} </label>
            ...
            @endforeach
                                            ...
                                            <div class="mb-3">
                                                <label for="" class="form-label">টেলিফোন নম্বর</label>
                                            ...
                                            <div class="mb-3">
                                                <label for="" class="form-label">ইমেইল এড্রেস</label>
            ...
            <div class="mb-3">
                <label for="" class="form-label">Telephone Number (টেলিফোন নম্বর)</label>
 ...
 $convert_new_ass_cat  = explode(",",$get_all_data_1->citizenship);
            ...
            <div class="mb-3">
                                    <label for="" class="form-label">বিগত ১০(দশ) বছরে বৈদেশিক অনুদানে পরিচালত কার্যক্রমের বিবরণ (প্রকল্প ওয়ারী তথাদির সংক্ষিপ্তসার সংযুক্ত করতে হবে)</label>
                                    <input type="file" name="foregin_pdf" data-parsley-required accept=".pdf" class="form-control" id="">
                                </div>

                                <div class="mb-3">
                                    <label for="" class="form-label">সংস্থার সম্ভাব্য/প্রত্যাশিত বার্ষিক বাজেট (উৎসসহ)</label>
